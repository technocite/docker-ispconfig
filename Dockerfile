...
RUN service mysql restart && apt-get -y install apache2 apache2-doc apache2-mpm-prefork apache2-utils libexpat1 ssl-cert libapache2-mod-php php php-common php-gd php-mysql php-imap phpmyadmin php-cli php-cgi libapache2-mod-fcgid apache2-suexec-custom php-pear php-auth php-mcrypt mcrypt php-imagick imagemagick libruby libapache2-mod-python php-curl php-intl php-memcache php-memcached php-pspell php-recode php-sqlite php-tidy php-xmlrpc php-xsl memcached libapache2-mod-passenger
